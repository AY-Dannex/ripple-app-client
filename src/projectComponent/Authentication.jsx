...
import { Loader2, ArrowBigLeft, ArrowLeft } from "lucide-react";
...
function Authentication(){
    ...
    return(
        <>
            <div className="w-full h-screen bg-[#060612]">
                <div>
                    <Button onClick={() => navigate("/")} className="absolute top-5 left-5 cursor-pointer bg-transparent text-white hover:bg-transparent"> <ArrowLeft className="mr-2"/> Back</Button>
                </div>
